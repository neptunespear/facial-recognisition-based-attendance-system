...
#contact
def contact():
    mess._show(title="Contact Me",message="If you find anything weird or you need any help contact me on 'kishlay7717@gmail.com'")

#about
def about():
    mess._show(title="About",message="This is facial based Attendance System is designed by Kishlay Kumar")
